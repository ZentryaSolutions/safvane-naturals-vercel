-- ═══════════════════════════════════════════════════════════════════
-- SAFVANE — Customer Reviews tables (run once in Supabase SQL Editor)
-- Dashboard: https://supabase.com/dashboard/project/kyswfxsqpmxjltuxzjtz/sql/new
-- ═══════════════════════════════════════════════════════════════════
...
-- Verify (should return 0 rows before any reviews are submitted)
SELECT 'product_reviews table ready' AS status, COUNT(*) AS review_count FROM product_reviews;
